...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "excel_clear_range",
            {"sheet": "Summary", "range": "A1:C3", "clear_type": "contents"},
            False,
            "_clear_range",
            "workbook_id",
        ),
        ...
        (
            "excel_paste_range",
            {"sheet": "Summary", "target_cell": "E1", "paste_type": "values"},
            False,
            "_paste_range",
            "workbook_id",
        ),
        (
            "excel_delete_cells",
            {"sheet": "Summary", "range": "A1:B2", "shift": "left"},
            False,
            "_delete_cells",
            "workbook_id",
        ),
        (
            "excel_insert_cells",
            {"sheet": "Summary", "range": "A1:B2", "shift": "right"},
            False,
            "_insert_cells",
            "workbook_id",
        ),
